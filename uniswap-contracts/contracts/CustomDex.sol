...
contract CustomDex {
    ...
    string[] public tokens = ["AskTrabaajo", "3DOT", "COKU"];

    // map to maintain the tokens and its instances
    mapping(string => ERC20) public tokenInstanceMap;

    // 1 AskTrabaajo/3DOT/COKU = 0.0001 eth
    uint256 ethValue = 5000000000000000000;

    // 0.0001 eth = 1 AskTrabaajo/3DOT/COKU
    // 1 AskTrabaajo/3DOT/COKU = 1 AskTrabaajo/3DOT/COKU
